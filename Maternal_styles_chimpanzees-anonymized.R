...
#put together
danger.model<-read.csv("protection-model-data-code.csv",sep=";",dec=",")
refusal.model<-read.csv("rejection-model-data-code.csv",sep=";",dec=",")
play.model<-read.csv("playing-model-data-code.csv",sep=";",dec=",")
groomed.model<-read.csv("groomed-model-data-code.csv",sep=";",dec=",")
contact.model<-read.csv("proximity-model-data-code.csv",sep=";",dec=",")
...
protection.intercept<-read.csv("protection.intercepts-code.csv",sep=";",dec=",")
rejection.intercept<-read.csv("rejection-intercepts-code.csv",sep=";",dec=",")
play.intercept<-read.csv("play-intercepts-code.csv",sep=";",dec=",")
groomed.intercept<-read.csv("groomed-intercepts-code.csv",sep=";",dec=",")
proximity.intercept<-read.csv("proximity-intercepts-code.csv",sep=";",dec=",")
...
write.csv2(behaviours.intercept,"behaviours-intercept-maternal-styles-code.csv")


behaviours.intercept<-read.csv("behaviours-intercept-maternal-styles-code.csv",sep=";",dec=",")
...
mother.PCA<-read.csv("behaviours-intercept-maternal-styles-code.csv",sep=';',dec=",")
...
mother.PCA <-  mother.PCA[ mother.PCA$Focal != "SF3", ]
mother.PCA<-  mother.PCA[ mother.PCA$Focal != "SM4", ]
mother.PCA <-  mother.PCA[ mother.PCA$Focal != "SF12", ]
mother.PCA <-  mother.PCA[ mother.PCA$Focal != "SF2", ]
mother.PCA <-  mother.PCA[ mother.PCA$Focal != "SM11", ]
mother.PCA <-  mother.PCA[ mother.PCA$Focal != "SM24", ]
mother.PCA <-  mother.PCA[ mother.PCA$Focal != "SF14", ]
mother.PCA <-  mother.PCA[ mother.PCA$Focal != "SF13", ]
mother.PCA <-  mother.PCA[ mother.PCA$Focal != "SF29", ]
mother.PCA <-  mother.PCA[ mother.PCA$Focal != "EF21", ]
mother.PCA <-  mother.PCA[ mother.PCA$Focal != "NF18", ]
mother.PCA <-  mother.PCA[ mother.PCA$Focal != "NM17", ]
...
mother.PCA$attachment.type[mother.PCA$Focal == "SM1"] <- "Secure"
mother.PCA$attachment.type[mother.PCA$Focal == "EM9"] <- "Secure-anxious"
mother.PCA$attachment.type[mother.PCA$Focal == "EM10"] <- "Secure-anxious"
mother.PCA$attachment.type[mother.PCA$Focal == "NM15"] <- "Secure-anxious"
mother.PCA$attachment.type[mother.PCA$Focal == "SM22"] <- "Secure"
mother.PCA$attachment.type[mother.PCA$Focal == "NF23"] <- "Secure"
mother.PCA$attachment.type[mother.PCA$Focal == "EM20"] <- "Insecure-avoidant"
mother.PCA$attachment.type[mother.PCA$Focal == "SM19"] <- "Secure"
mother.PCA$attachment.type[mother.PCA$Focal == "EF7"] <- "Secure"
mother.PCA$attachment.type[mother.PCA$Focal == "SM8"] <- "Secure-anxious"
mother.PCA$attachment.type[mother.PCA$Focal == "SF27"] <- "Secure"
mother.PCA$attachment.type[mother.PCA$Focal == "NM16"] <- "Secure"
mother.PCA$attachment.type[mother.PCA$Focal == "SM28"] <- "Insecure-avoidant"
mother.PCA$attachment.type[mother.PCA$Focal == "SF6"] <- "Insecure-avoidant"
mother.PCA$attachment.type[mother.PCA$Focal == "EM5"] <- "Secure"
mother.PCA$attachment.type[mother.PCA$Focal == "SM26"] <- "Insecure-avoidant"
mother.PCA$attachment.type[mother.PCA$Focal == "EM30"] <- "Insecure-avoidant"
mother.PCA$attachment.type[mother.PCA$Focal == "SM25"] <- "Insecure-avoidant"
...
write.csv2(score,"score.pca-code.csv")
...
refusal.intercept<-read.csv("rejection-intercepts-code.csv",sep=";",dec=",")
protection.intercept<-read.csv("protection.intercepts-code.csv",sep=";",dec=",")
...
behaviours.intercept <-  behaviours.intercept[ behaviours.intercept$Focal != "SF3", ]
behaviours.intercept<-  behaviours.intercept[ behaviours.intercept$Focal != "SM4", ]
behaviours.intercept <-  behaviours.intercept[ behaviours.intercept$Focal != "SF12", ]
behaviours.intercept <-  behaviours.intercept[ behaviours.intercept$Focal != "SF2", ]
behaviours.intercept <-  behaviours.intercept[ behaviours.intercept$Focal != "SM11", ]
behaviours.intercept <-  behaviours.intercept[ behaviours.intercept$Focal != "SM24", ]
behaviours.intercept <-  behaviours.intercept[ behaviours.intercept$Focal != "SF14", ]
behaviours.intercept <-  behaviours.intercept[ behaviours.intercept$Focal != "SF13", ]
behaviours.intercept <-  behaviours.intercept[ behaviours.intercept$Focal != "SF29", ]
behaviours.intercept <-  behaviours.intercept[ behaviours.intercept$Focal != "EF21", ]
behaviours.intercept <-  behaviours.intercept[ behaviours.intercept$Focal != "NF18", ]
behaviours.intercept <-  behaviours.intercept[ behaviours.intercept$Focal != "NM17", ]


#make nice plot with red lines and colors no names

behaviours.intercept$attachment.type[behaviours.intercept$Focal == "SM1"] <- "Secure"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "EM9"] <- "Secure-anxious"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "EM10"] <- "Secure-anxious"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "NM15"] <- "Secure-anxious"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "SM22"] <- "Secure"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "NF23"] <- "Secure"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "EM20"] <- "Insecure-avoidant"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "SM19"] <- "Secure"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "EF7"] <- "Secure"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "SM8"] <- "Secure-anxious"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "SF27"] <- "Secure"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "NM16"] <- "Secure"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "SM28"] <- "Insecure-avoidant"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "SF6"] <- "Insecure-avoidant"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "EM5"] <- "Secure"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "SM26"] <- "Insecure-avoidant"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "EM30"] <- "Insecure-avoidant"
behaviours.intercept$attachment.type[behaviours.intercept$Focal == "SM25"] <- "Insecure-avoidant"
...
refusal.intercept<-read.csv("rejection-intercepts-code.csv",sep=";",dec=",")
danger.intercept<-read.csv("protection.intercepts-code.csv",sep=";",dec=",")
...
mpriorj.protectiveness = get_prior(attachment.type ~ rejection.Intercept+ protection.Intercept+play.Intercept
                                   ,
...
mpriorj.protectiveness$prior[2:4] <- "normal(0,1)"# so here change the indexing to the rows containing your fixed effects

mpriorj.protectiveness$prior[7:9] <- "normal(0,1)"# again here.
...
make_stancode(attachment.type ~ rejection.Intercept+ protection.Intercept+play.Intercept
              ,
...
b.mother.protection2.no.inte = brm(attachment.type ~ rejection.Intercept+ protection.Intercept+play.Intercept
                                   ,
...
hypothesis(b.mother.protection2.no.inte, "muSecureanxious_rejection.Intercept    =muSecure_rejection.Intercept    ", class = "b", group = "",
           scope = c("standard", "ranef", "coef"), alpha = 0.11, seed = NULL)


hypothesis(b.mother.protection2.no.inte, "muSecureanxious_protection.Intercept   =muSecure_protection.Intercept   ", class = "b", group = "",
           scope = c("standard", "ranef", "coef"), alpha = 0.11, seed = NULL)

hypothesis(b.mother.protection2.no.inte, "muSecureanxious_play.Intercept   =muSecure_play.Intercept    ", class = "b", group = "",
